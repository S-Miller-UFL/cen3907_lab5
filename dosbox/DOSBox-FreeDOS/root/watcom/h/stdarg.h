...
#elif defined(_M_IX86)
 #if defined(__HUGE__) || defined(__SW_ZU)
  #define va_start(__ap,__pn)   ((__ap)[0]=(char _WCFAR*)&__pn+\
      ((sizeof(__pn)+sizeof(int)-1)&~(sizeof(int)-1)),(void)0)
  #define va_arg(__ap,__type)   ((__ap)[0]+=\
      ((sizeof(__type)+sizeof(int)-1)&~(sizeof(int)-1)),\
      (*(__type _WCFAR*)((__ap)[0]-((sizeof(__type)+sizeof(int)-1)&~(sizeof(int)-1)))))
  #define va_end(__ap)          ((__ap)[0]=0,(void)0)
 #else
  #define va_start(__ap,__pn)   ((__ap)[0]=(char *)&__pn+\
      ((sizeof(__pn)+sizeof(int)-1)&~(sizeof(int)-1)),(void)0)
  #define va_arg(__ap,__type)   ((__ap)[0]+=\
      ((sizeof(__type)+sizeof(int)-1)&~(sizeof(int)-1)),\
      (*(__type *)((__ap)[0]-((sizeof(__type)+sizeof(int)-1)&~(sizeof(int)-1)))))
  #define va_end(__ap)          ((__ap)[0]=0,(void)0)
 #endif
#endif
...
#else
 #define __va_copy(__dest,__src)    ((__dest)[0]=(__src)[0],(void)0)
#endif

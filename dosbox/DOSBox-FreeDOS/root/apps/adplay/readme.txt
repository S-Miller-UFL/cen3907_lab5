...
AdPlay/DOS 1.6a, Copyright (c) 2000 - 2007 Simon Peter <dn.tlp@gmx.net>
...
requires an installed OPL2/3 audio board for song replay. No emulated playback
is supported.
...
- SNG: Adlib Tracker 1.0 by TJ
  - Needs file 'songname.ins' in the same directory as loaded file, where
   'songname' is the song's filename without '.sng' extension
